...
function barebones_enqueue_scripts() {
    ...
    wp_enqueue_style( 'styles', get_stylesheet_directory_uri() . '/nightmode.css?' . filemtime( get_stylesheet_directory() . '/nightmode.css' ) );
...
add_theme_support( 'post-thumbnails' );
add_image_size('featuredImageCropped', 400, 400, true);
...
function mytheme_customize_css()
{
    ...
    <style type="text/css">
        .navcontainer {
        background-color: <?php echo get_theme_mod('accent_color', "#47186d"); ?>;
        }

        .card--title{
            border-bottom: <?php echo get_theme_mod('accent_color', "#47186d"); ?> 5px solid;
        }
